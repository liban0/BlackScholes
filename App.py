...
with st.sidebar:
    ...
    st.write("`Created by:`")
    linkedin_url = "https://www.linkedin.com/in/liban-abdulkadir-731970195"
    st.markdown(f'<a href="{linkedin_url}" target="_blank" style="text-decoration: none; color: inherit;"><img src="https://cdn-icons-png.flaticon.com/512/174/174857.png" width="25" height="25" style="vertical-align: middle; margin-right: 10px;">`https://www.linkedin.com/in/liban-abdulkadir-731970195/overlay/about-this-profile/?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base%3BzF4ZA%2Fk8QnmtS6Pa%2FtO0oA%3D%3D`</a>', unsafe_allow_html=True)
